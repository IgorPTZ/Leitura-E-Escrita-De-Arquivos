	...
	public static void main(String[] args) {
		...
		try {
			...
			while(iteratorDeLinhas.hasNext()) {
				...
				int quantidadeDeCelulas = linha.getPhysicalNumberOfCells();
				
				// Cria uma nova celula na linha da planilha dinamicamente
				Cell cell = linha.createCell(quantidadeDeCelulas);
